...
Java_com_example_face_1recognition_detector_FaceSDKNative_faceDetectionModelInit(JNIEnv *env,
                                                                                 jobject instance,
    ...
    ultra = new UltraFace(str, 128, 96, 4, 0.65); // config model input
...
Java_com_example_face_1recognition_detector_FaceSDKNative_faceDetect(JNIEnv *env, jobject instance,
...
JNIEXPORT jboolean JNICALL
Java_com_example_face_1recognition_detector_FaceSDKNative_faceDetectionModelUnInit(JNIEnv *env,
                                                                                   jobject instance) {
